...
times = [0, 300, 900, 1800, 3600]   # up to 60 min
...
plt.title("Transient Diffusion: Lower Temp (900°C) & Lower Dose (5e13)")
plt.grid(True, which='both', linestyle='--', alpha=0.7)
plt.legend()
plt.savefig("transient_lowT_lowDose.png", dpi=150, bbox_inches='tight')
print("Saved: transient_lowT_lowDose.png")
